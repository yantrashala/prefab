...
const CiCdSetup = (props: any) => {
  ...
  const onHostingProviderChange = (event: any) => setHostingProvider(event.target.value);
  const onCodeReviewChange = (event: any) => setCodeReview(event.target.value);
  return (
    <MuiThemeProvider theme={psTheme}>
      ...
      <FormControl className="form-container" fullWidth>
        <TextField
          ...
          onChange={useCallback(onHostingProviderChange, [])}
          margin="normal"
        >
      ...
      <FormControl className="form-container" fullWidth>
        <TextField
          ...
          value={codeReview}
          onChange={useCallback(onCodeReviewChange, [])}
          margin="normal"
        >
